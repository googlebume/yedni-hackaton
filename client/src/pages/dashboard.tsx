        ...
        <div className="flex gap-3">
          {!user.isDiiaVerified && (
            <Button 
              ...
              onClick={verifyDiia}
            >
              <img src="https://lh3.google.com/d/1vPXpO-csD_L_W0NvLnuwULNzFurYTh7Y" alt="Verify" className="h-4 w-4" />
              Verify with Diia
            </Button>
          )}
          {isOrg && (
      ...
      {!user.isDiiaVerified && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 flex items-start gap-4">
          <div className="bg-blue-100 dark:bg-blue-800 p-2 rounded-full">
            <img src="https://lh3.google.com/d/1vPXpO-csD_L_W0NvLnuwULNzFurYTh7Y" alt="Verification" className="h-5 w-5" />
          </div>
          <div>

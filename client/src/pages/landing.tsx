          ...
          <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-3 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="p-3 rounded-full">
                <img src="https://drive.google.com/uc?export=view&id=1vPXpO-csD_L_W0NvLnuwULNzFurYTh7Y" alt="Verified" className="h-6 w-6" />
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-md flex items-center justify-center">
              <img src="https://drive.google.com/uc?export=view&id=1vPXpO-csD_L_W0NvLnuwULNzFurYTh7Y" alt="Yedno" className="h-5 w-5" />
            </div>
